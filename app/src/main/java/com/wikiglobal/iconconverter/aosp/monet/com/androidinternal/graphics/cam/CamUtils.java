...
package com.androidinternal.graphics.cam;


import android.graphics.Color;

import androidx.annotation.NonNull;
import com.androidinternal.graphics.AospColorCompat;
...
public final class CamUtils {
    ...
    static float yFromInt(int argb) {
        final float r = linearized(AospColorCompat.red(argb));
        final float g = linearized(AospColorCompat.green(argb));
        final float b = linearized(AospColorCompat.blue(argb));
