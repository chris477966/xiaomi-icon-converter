...
public final class ColorUtils {
    ...
    public static int compositeColors(@ColorInt int foreground, @ColorInt int background) {
        int bgAlpha = AospColorCompat.alpha(background);
        int fgAlpha = AospColorCompat.alpha(foreground);
        int a = compositeAlpha(fgAlpha, bgAlpha);

        int r = compositeComponent(AospColorCompat.red(foreground), fgAlpha,
                AospColorCompat.red(background), bgAlpha, a);
        int g = compositeComponent(AospColorCompat.green(foreground), fgAlpha,
                AospColorCompat.green(background), bgAlpha, a);
        int b = compositeComponent(AospColorCompat.blue(foreground), fgAlpha,
                AospColorCompat.blue(background), bgAlpha, a);

        return AospColorCompat.argb(a, r, g, b);
    }
    ...
    public static double calculateContrast(@ColorInt int foreground, @ColorInt int background) {
        if (AospColorCompat.alpha(background) != 255) {
            throw new IllegalArgumentException("background can not be translucent: #"
                    + Integer.toHexString(background));
        }
        if (AospColorCompat.alpha(foreground) < 255) {
    ...
    public static void colorToHSL(@ColorInt int color, @NonNull float[] outHsl) {
        RGBToHSL(AospColorCompat.red(color), AospColorCompat.green(color), AospColorCompat.blue(color), outHsl);
    }
    ...
    public static int HSLToColor(@NonNull float[] hsl) {
        ...
        return AospColorCompat.rgb(r, g, b);
    }
    ...
    public static void colorToLAB(@ColorInt int color, @NonNull double[] outLab) {
        RGBToLAB(AospColorCompat.red(color), AospColorCompat.green(color), AospColorCompat.blue(color), outLab);
    }
    ...
    public static void colorToXYZ(@ColorInt int color, @NonNull double[] outXyz) {
        RGBToXYZ(AospColorCompat.red(color), AospColorCompat.green(color), AospColorCompat.blue(color), outXyz);
    }
    ...
    public static int blendARGB(@ColorInt int color1, @ColorInt int color2,
        ...
        float a = AospColorCompat.alpha(color1) * inverseRatio + AospColorCompat.alpha(color2) * ratio;
        float r = AospColorCompat.red(color1) * inverseRatio + AospColorCompat.red(color2) * ratio;
        float g = AospColorCompat.green(color1) * inverseRatio + AospColorCompat.green(color2) * ratio;
        float b = AospColorCompat.blue(color1) * inverseRatio + AospColorCompat.blue(color2) * ratio;
        return AospColorCompat.argb((int) a, (int) r, (int) g, (int) b);
    }
