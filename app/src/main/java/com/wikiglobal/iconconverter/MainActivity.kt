            ...
            MaterialTheme(colorScheme = colors ?: androidx.compose.material3.lightColorScheme()) {
                Surface {
                    IconConverterScreen(
                        ...
                        onOpenPicker = viewModel::openIconPicker,
                        onClosePicker = viewModel::closeIconPicker,
                        onPickerPack = viewModel::selectPickerIconPack,
                        onSearchIcons = viewModel::searchIcons,
                        onChooseIcon = viewModel::chooseIcon,
                        onRestoreAutomatic = viewModel::restoreAutomaticIcon,
                        onSetActivePack = viewModel::setActiveIconPack,
                        onDeletePack = viewModel::deleteIconPack,
